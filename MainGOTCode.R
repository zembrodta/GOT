...
ggplot(JD, aes(variable, value ))+geom_line(aes(group = character, color = character), JD$Color lwd = 2)
...
Season1Top = top_n(HouseScreenTime, 5, season1)
Season2Top = top_n(HouseScreenTime, 5, season2)
Season3Top = top_n(HouseScreenTime, 5, season3)
Season4Top = top_n(HouseScreenTime, 5, season4)
Season5Top = top_n(HouseScreenTime, 5, season5)
Season6Top = top_n(HouseScreenTime, 5, season6)
Season7Top = top_n(HouseScreenTime, 5, season7)


ggplot( Season1Top, aes(x= reorder(House,season1), season1))+geom_bar(stat = 'identity',aes(fill = House))+coord_flip()+ labs( x = "Season 1", y = "House", title = "Season 1 Screen Time")
ggplot( Season2Top, aes(x= reorder(House,season2), season2))+geom_bar(stat = 'identity',aes(fill = House))+coord_flip()+ labs( x = "Season 2", y = "House", title = "Season 2 Screen Time")
...
ggplot( Season1TopChar, aes(x= reorder(character,season1), season1))+geom_bar(stat = 'identity',aes(fill = House))+coord_flip()+ labs( x = "Season 1", y = "character", title = "Season 1 Screen Time")
